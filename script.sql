...
INSERT IGNORE INTO `employe` (`id`, `entreprise_id`, `nom`, `prenom`, `date_naissance`, `date_embauche`, `ville`) VALUES
	(1, 1, 'SMAIL', 'Stéphane', '1982-04-10 14:29:59', '2019-11-10 14:30:08', 'Mulhouse'),
	(2, 1, 'MATHIEU', 'Quentin', '1997-04-10 14:31:05', '2022-06-10 14:31:18', 'Strasbourg'),
	(3, 1, 'MURMANN', 'Mickael', '1985-04-10 14:32:15', '2010-08-10 14:32:33', 'Strasbourg'),
	(4, 2, 'ANDRES', 'Mathilde', '1994-04-10 00:00:00', '2015-04-10 00:00:00', 'Strasbourg'),
	(5, 1, 'GUTNECHT', 'Nicolas', '1990-03-31 00:00:00', '2020-02-01 00:00:00', 'Colmar');
...
INSERT IGNORE INTO `entreprise` (`id`, `raison_sociale`, `date_creation`, `adresse`, `cp`, `ville`) VALUES
	(1, 'ELAN FORMATION', '1997-07-10 00:00:00', '202 avenue de Colmar', '67000', 'Strasbourg'),
	(2, 'COACTIS', '2015-07-10 00:00:00', '10 Rue Jacobi-Netter', '67200', 'Strasbourg'),
	(4, 'MON ENTREPRISE', '1998-01-15 00:00:00', '10 Route du rhin', '67100', 'Strasbourg');
